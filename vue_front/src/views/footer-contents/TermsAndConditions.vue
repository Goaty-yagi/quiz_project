    ...
    data(){
        return{
            termsAndConditions:[
                {
                    title:'利用規約',
                    description:['この利用規約（以下，「本規約」といいます。）は，ねこJAPANESE（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。']
                },
                {
                    title:'第1条（適用）',
                    description:[
                    ...
                    description:[
                        {
                            ...
                            detail:[
                                ...
                                '他のユーザーに成りすます行為',
                                {
                                    detail:'以下の表現を含み，または含むと当社が判断する内容を本サービス上に投稿し，または送信する行為',
                                    moreDetail:[
                                        '過度に暴力的な表現',
                                        '露骨な性的表現',
                                ...
                                {
                                    detail:'その他反社会的な内容を含み他人に不快感を与える表現',
                                    moreDetail:[
                ...
                },
                {
                    ...
                    description:[
                        {
                            description:'当社は，以下のいずれかの事由があると判断した場合，ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。',
                            detail:[
                ...
                },
                {
                    ...
                    description:[
                        {
                            description:'当社は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーとしての登録を抹消することができるものとします。',
                            detail:[
                                '本規約のいずれかの条項に違反した場合',
                ...
                },
                {
                    ...
                    description:[
                        {
                            description:'当社は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。',
                            detail:[
